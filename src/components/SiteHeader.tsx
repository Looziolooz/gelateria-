      ...
      <header className="fixed inset-x-0 top-0 z-50 bg-cream/95 backdrop-blur-sm shadow-[0_1px_0_rgba(106,63,36,0.12)]">
        <div className="site-wrap flex items-center justify-between gap-6 py-4 md:py-5">
          ...
          <div className="flex items-center gap-3 md:gap-5">
            <div className="hidden sm:flex items-center gap-1 text-[12px] uppercase tracking-[0.12em] font-semibold text-secondary">
              <span className="text-primary">it</span>
              <span className="opacity-40">/</span>
              <span className="opacity-70 hover:opacity-100 cursor-pointer">en</span>
            </div>
            <Link href="/pickup" className="btn-pill hidden sm:inline-flex !py-2.5 !px-5 !text-[12px]">
              Prenota
            </Link>
            <button
              type="button"
            ...
            >
              <Menu size={22} />
              <span className="hidden sm:inline core t-u text-[12px] font-semibold" style={{ letterSpacing: "0.2em" }}>
                Naviga
              </span>
            </button>
          </div>
